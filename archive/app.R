        ...
        tabItems(
            ...
            tabItem("data",
                    fluidPage(
                        ...
                        br(),
                        h3("The Data"),
                        p("The raw data comes from ", a("histdata", 
                            href = "https://www.histdata.com/download-free-forex-historical-data/?/metatrader/1-minute-bar-quotes/EURUSD"), ".", style = "font-size:20px;"),
                        br(),
